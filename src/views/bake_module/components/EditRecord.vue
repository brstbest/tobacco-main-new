<template>
  <div class="edit-record-comp">
    <el-row class="edit-record-form">
          ...
          <el-col :span="12">
            <el-form-item label="开始时间">
              <el-date-picker
                ...
                type="datetime"
                placeholder="选择开始日期时间" @change="startTimeChange">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="结束时间">
              <el-date-picker
                ...
                type="datetime"
                placeholder="选择结束日期时间" @change="endTimeChange">
              </el-date-picker>
            </el-form-item>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      startTimeChange() {
        this.recordForm.start_time = this.formatDateTime(this.recordForm.start_time)
      },
      endTimeChange() {
        this.recordForm.end_time = this.formatDateTime(this.recordForm.end_time)
      },
      confirmClick() {
        let rdata = {
          ...
          farmer_id: this.recordForm.farmer_id,
          technician_id: this.recordForm.technician_id,
          device_id: this.recordForm.device_id,
          baking_weight_before: this.recordForm.baking_weight_before,
          baking_weight_after: this.recordForm.baking_weight_after,
          score: this.recordForm.score,
          tobacco_info: this.recordForm.tobacco_info
        }
        console.log(rdata)
