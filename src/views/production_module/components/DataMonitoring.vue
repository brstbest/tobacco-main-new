...
export default {
  ...
  created() {
    ...
    * */
    ...
    this.start_time.setDate(this.end_time.getDate() - 30)
    this.end_time = this.formatDateTime(this.end_time)
    this.start_time = this.formatDateTime(this.start_time)
    ...
    dataMonitoringRequest(params).then(res => {
      console.log('res', res)
      const t = {}
      // 前端计算太慢
      res.data.forEach(r => {
      ...
      console.log('runningDevice', runningDevice)
      console.log('abnormalDevice', abnormalDevice)
